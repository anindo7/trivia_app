        ...
        { view: View ->
            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    // Navigation.findNavController(view).navigate(R.id.action_gameFragment_to_gameLoseFragment)
                    view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameLoseFragment())
                }
            }
        }
        return binding.root
